...
In this lesson, as the name suggests, we'll discuss p-values which are the most common measure of statistical significance.
...
suppressWarnings(g <- g + geom_path(x=2.0,size=1.5,colour="blue"))
...
g <- ggplot(dat, aes(x = x, y = y)) +
     geom_line(size = 1.5)+scale_y_continuous(limits=c(0,max(dat$y)))
